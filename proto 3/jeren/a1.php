    ...
    <div id="pageintro" class="hoc clear"> 
	   ...
	   <article>
        ...
        <footer>
		  ...
		  <li><a href="a2.php"><input class="btn inverse" type="submit" value="INSERTION AND DELETION"></a></li>
		   <li><a href="a4.php"><input class="btn inverse" type="submit" value="UPDATION"></a></li>
      ...
      <article>
        ...
        <div>
          <p class="heading"></p>
          <h2 class="heading">Edit Student Timetable</h2>
          
        </div>
		<form action="a3.php" method="post">
         
		
		 SEC:<input id="inp1" type="text" name="sec" style="color:black" required/>		
		<br/>
         YEAR:<input id="inp2" type="text" name="year" style="color:black" required/>
		<br/>
		<footer>
          <ul class="nospace inline pushright">
