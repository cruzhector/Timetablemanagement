...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/b.jpg');">
    <div id="pageintro" class="hoc clear"> 
      ...
      <article>
        <div>
          <p class="heading">ARVIS INSTITUTE</p>
          <h2 class="heading"></h2>
          <p>Please Choose The Type to edit </p>
        </div>
        <footer>
          <ul class="nospace inline pushright">
		  <li><a href="s1.php"><input class="btn inverse" type="submit" value="STAFF"></a></li>
		  <li><a href="a1.php"><input class="btn inverse" type="submit" value="STUDENT"></a></li>
		  <li><a href="newseclog.php"><input class="btn inverse" type="submit" value="NEW SEC ENTRY"></li>
			</ul>
        </footer>
      </article>
