    ...
    <div id="pageintro" class="hoc clear"> 
      ...
      <article>
        <div>
          ...
          <h2 class="heading"></h2>
          <p>Please Choose The YEAR </p>
        </div>
        <footer>
          <ul class="nospace inline pushright">
		  <form action="newsc1.php" method="post">
		  <li><a href=""><input class="btn inverse" type="submit" name="s1" value="1st YEAR"></a></li>
		  </form>
		  <form action="newsc2.php" method="post">
		  <li><a href=""><input class="btn inverse" type="submit" name="s2" value="2nd YEAR"></a></li>
		  </form>
			</ul>
        </footer>
      </article>
