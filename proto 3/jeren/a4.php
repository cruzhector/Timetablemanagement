...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/b.jpg');">
    <div id="pageintro" class="hoc clear"> 
      ...
      <article>
	  <div>
          <p class="heading">STUDENT UPDATE RECORD</p>
          
          
        </div>
        <form method="post" action="a5.php">
		
		 ID:<input id="inp1" type="text" name="userid" style="color:black" required/>		
		<br/>
		
		<ul class="nospace inline pushright">
            <li><input class="btn inverse" type="submit" name="go" value="GO"></li>
