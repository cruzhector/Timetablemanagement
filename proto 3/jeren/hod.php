...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/ins3.jpg');">
    <div id="pageintro" class="hoc clear"> 
      ...
      <article>
        <div>
          <p class="heading"></p>
          <h2 class="heading">HOD LOGIN</h2>
          <p>Please Login</p>
        </div>
		<form action="LoginServlet" method="post" target="_blank" >
		
		Username:<input id="inp1" type="text" name="username" style="color:black"/>
		<br/>
        Password:<input id="inp2" type="password" name="password" style="color:black"/>
		
		<br/>
		<br/>
		<footer>
          <ul class="nospace inline pushright">
		  <form action="ttpage.html">
            <li><input class="btn inverse" type="button" value="LOG IN" onclick="redirect()"/></li>
            <li><input class="btn inverse" type="button" value="SIGN UP"/></li>
		  </form>	
			</ul>
        </footer>
      </form>
