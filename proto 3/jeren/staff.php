...
session_start();
	...
	$sql = "SELECT * FROM faculty WHERE fid='$user' ";
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/ins3.jpg');">
    <div id="pageintro" class="hoc clear"> 
      ...
      <article>
        <div>
          <p class="heading"></p>
          <h2 class="heading">STAFF TIME TABLE VIEW</h2>
          <p>Please Enter</p>
        </div>
		<form action="staff.php" method="post" target="_blank" >
		
		Username:<input id="inp1" type="text" name="username" style="color:black" placeholder="faculty id" required/>
		<br/>
