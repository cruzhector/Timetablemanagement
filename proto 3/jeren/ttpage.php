...
$sql = "SELECT p1,p2,p3,p4,p5,p6,p7,p8,sday FROM speriod WHERE ssec='$sec'  AND syear='$year' ";
$sql2 = "SELECT sname FROM student WHERE sid='".$_SESSION['username']."' ";
$sql3 = "SELECT ssem FROM student WHERE sid='".$_SESSION['username']."' ";
  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="nospace">
        ...
        <?php 
		echo '<form method="post" action="ttpage.php"><li><input type="submit" value="logout" name="logout"/></li></form>';  ?>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    <div id="logo" class="fl_left">
	  ...
	  <b><p><img src="images/demo/avatar.png" alt="blank"></img> <?php echo $_SESSION['username']; $table2 = mysqli_query($conn,$sql2); $row2 = mysqli_fetch_array($table2);  echo $row2['sname'];?>   </p></b>
    </div>
...
<tr>
    <th style="background-color: #45B5CA;"  "color: white;" cellpadding="5">Alotted to sem:<?php $table3 = mysqli_query($conn,$sql3); $row3 = mysqli_fetch_array($table3);  echo $row3['ssem'];?> </th>
  ...
  <tr>
    <th style="background-color: #4CAF50;"  "color: white;" cellpadding="5"><?php echo $row['sday'];?></th>
